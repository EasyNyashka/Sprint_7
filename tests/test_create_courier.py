...
from generators import generate_courier, generate_courier_not_password, generate_courier_not_login
...
class TestCreateCourier:
    ...
    def test_create_courier(self):
        ...
        response = requests.post(f'{Url.BASE_URL}{Url.CREATE_COURIER}', json=TestCreateCourier.courier_data)
    ...
    def test_create_courier_twice(self):
        ...
        twice_response = requests.post(f'{Url.BASE_URL}{Url.CREATE_COURIER}', json=TestCreateCourier.courier_data)
